...
# Path to your oh-my-zsh installation.
  export ZSH=/home/napster/.oh-my-zsh

# Set name of the theme to load. Optionally, if you set this to "random"
# it'll load a random theme each time that oh-my-zsh is loaded.
# See https://github.com/robbyrussell/oh-my-zsh/wiki/Themes
ZSH_THEME="agnoster"
DEFAULT_USER=napster
prompt_context(){}

eval `dircolors /home/napster/.dir_colors/dircolors`
...
# dont write command that start with a space to the history
# useful when doing secret stuff
setopt histignorespace

#dont send environment vars by default
...
# added by travis gem
[ -f /home/napster/.travis/travis.sh ] && source /home/napster/.travis/travis.sh
